...
class ViewController3: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        overallLabel.text = reviewData.overall
       
        lightingLabel.text = reviewData.lighting
        
        noiseLevelLabel.text = reviewData.noiseLevel
        
        crowdednessLabel.text = reviewData.crowdedness
        
        smellLabel.text = reviewData.smell
        
        arrivalTimeLabel.text = reviewData.arrivalTime
